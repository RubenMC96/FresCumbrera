...
const AVISORRSS = document.getElementById("avisoRRSS");
...
function validarRRSS(){
    let regexEmail = /^[a-zA-Z0-9@#$%^&*\-_./]{3,30}$/;

    let elemento = document.getElementById("rrss");

    if(regexEmail.test(elemento.value)){
        return true;
    }
    else{
        error(elemento, "<b>!</b> Ups... eso no parece el nombre se usuario de una red  social. Inténtelo de nuevo.")
        return false;
    }
...
function error(elemento, mensaje){
    ...
    switch(idElemento){
        ...
        case "email":
            ...
            break;
        case "rrss":
            AVISORRSS.innerHTML = mensaje;
            AVISORRSS.className = "mensajeError";
            break;
        case "mensaje":
